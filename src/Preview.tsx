...
export default function Preview({ info }) {
    ...
    return (<>
        <div className='flex flex-row lg:mx-[10vw] min-h-[20vh] mt-10'>
            <div className='basis-2/3'>
                <div className='text-xl font-semibold'>{info.title}</div>
                <div className='text-xs mt-3 whitespace-pre-wrap'>{description}</div>
                <button className='text-sm mt-1 hover:bg-[#333333] px-1.5 rounded-2xl' onClick={toggleDescription}>{buttonText}</button>
            </div>
